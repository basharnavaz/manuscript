...
\datedepot{"February 17, 2020"}

\directeur{Mr. }{Maarouf Saad}{Département de Génie Électrique, École de technologie supérieure}

\codirecteur{Mrs. }{Hannah Michalska}{Department of Electrical and Computer Engineering, McGill University}

\president{Mr. }{Guy Gauthier}{Département d'ingénierie des Systèmes, École de technologie supérieure}

\jury{Mr. }{Jean-Pierre Kenné}{Département de Génie Mécanique, École de technologie supérieure}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=3.5in,height=2in]{Figures/results/chaotic_disturbances/dis_m1_att.eps}}
...
\begin{figure}[H]
\centering
\fbox{\includegraphics[width=3.5in,height=2in]{Figures/results/chaotic_disturbances/dis_m2_att.eps}}
...
\begin{figure}[H]
	\centering
	\fbox{\includegraphics[width=0.75\textwidth]{Figures/dist_pract/res1/view.png}}
